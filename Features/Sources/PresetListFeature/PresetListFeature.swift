...
//    var activePreset: SoundFontPresetId
//    var selectedSoundFontId: UUID
...
//    case presetButtonTapped(presetIndex: Int)
...
//      switch action {
//      case let .presetButtonTapped(presetIndex):
//        state.activePreset = .init(soundFont: selectedSoundFontId, preset: presetIndex)
//        return .none
//
//      case .searchButtonTapped:
...
//  @Query
//  private var presets: [PresetModel]
//  @Bindable private var store: StoreOf<PresetListFeature>
//
//  public init(store: StoreOf<PresetListFeature>) {
//    self.store = store
//    self._presets = Query(PresetModel.fetchDescriptor(for: store.selectedSoundFontId), animation: .default)
//  }
//
