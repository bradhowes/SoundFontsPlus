...
public struct Note: CustomStringConvertible, Codable {
  ...
  public static let noteLabels: [String] = ["C",
                                            "C" + sharpTag,
                                            "D",
                                            "D" + sharpTag,
                                            "E",
                                            ...
                                            "A" + sharpTag,
                                            "B"]
  public static let solfegeLabels: [String] = ["Do", "Do", "Re", "Re", "Mi", "Fa", "Fa", "Sol", "Sol", "La", "La", "Ti"]
  public static let sharpIndices: Set<Int> = [1, 3, 6, 8, 10]
