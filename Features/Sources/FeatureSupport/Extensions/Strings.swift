...
/// Collection of image names from SF Symbols used in the app.
public extension String {
  ...
  static var circledCheckMarkOnImageName: String { "checkmark.circle.fill" }
  static var deleteButtonImageName: String { "trash" }
  static var duplicateFavoriteButtonName: String { "document.on.document.fill" }
  static var editButtonImageName: String { "pencil" }
  static var effectsButtonImageName: String { "waveform" }
  static var effectsLockButtonImageName: String { "lock" }
  static var effectsToggleOffButtonImageName: String { "arrowtriangle.down" }
  ...
  static var lessButtonImageName: String { "chevron.down"}
