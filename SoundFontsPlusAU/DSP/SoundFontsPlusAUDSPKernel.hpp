...
#import "SoundFontsPlusAUParameterAddresses.h"

/*
 SoundFontsPlusAUDSPKernel
 As a non-ObjC class, this is safe to use from render thread.
 */
class SoundFontsPlusAUDSPKernel {
public:
    ...
    // Add a case for each parameter in SoundFontsPlusAUParameterAddresses.h
    void setParameter(AUParameterAddress address, AUValue value) {
        switch (address) {
            case SoundFontsPlusAUParameterAddress::gain:
                mGain = value;
                break;
        }
    }
    ...
    void handleMIDIEventList(AUEventSampleTime now, AUMIDIEventList const* midiEvent) {
        auto visitor = [] (void* context, MIDITimeStamp timeStamp, MIDIUniversalMessage message) {
            auto thisObject = static_cast<SoundFontsPlusAUDSPKernel *>(context);
