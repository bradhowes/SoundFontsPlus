//
//  SoundFontsPlusAUAUProcessHelper.hpp
//  SoundFontsPlusAU
//
...
#include <vector>
#include "SoundFontsPlusAUDSPKernel.hpp"

//MARK:- AUProcessHelper Utility Class
class AUProcessHelper
{
public:
    AUProcessHelper(SoundFontsPlusAUDSPKernel& kernel)
    : mKernel{kernel}
    {
    }
...
private:
    SoundFontsPlusAUDSPKernel& mKernel;
