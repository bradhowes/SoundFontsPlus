...
public final class AVSF2Engine {
  ...
  public init() {
    ...
    guard let sf2Engine = avAudioUnit.auAudioUnit as? SF2LibAU else { fatalError() }
  ...
  public static func instantiate(completionHandler: @escaping (AVAudioUnit?, Error?) -> Void) {
    AUAudioUnit.registerSubclass(SF2LibAU.self, as: AVSF2Engine.audioComponentDescription, name: "SF2Engine",
                                 version: 1)
